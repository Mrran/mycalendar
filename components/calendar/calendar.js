...
Component({
  ...
  observers: {
    ...
    'targetDate': function (targetDateStr) {
      ...
      this.setData({
        selectedYmd: this._getDateKeys(thatDate).ymd
      })
  ...
  methods: {
    ...
    onBackToToday() {
      this.setData({
        selectedYmd: this.data.today.ymd
      })
        ...
        self.setData({
          ...
          setTimeout(() => {
            self.setData({
              ...
              self.triggerEvent('cal-show-toggle', {
                isCalShow: true
              })
            })
          }, 100)
